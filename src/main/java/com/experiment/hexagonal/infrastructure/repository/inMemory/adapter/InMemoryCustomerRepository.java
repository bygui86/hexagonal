...
public class InMemoryCustomerRepository implements CustomerRepository {
    ...
    public InMemoryCustomerRepository(
        ...
        this.CUSTOMER_MAPPER = inMemoryCustomer -> {
            Optional<User> user = userRepository.get(inMemoryCustomer.getUserId());
            Optional<Adresse> adresse = adresseRepository.get(inMemoryCustomer.getAdresseId());                    
            return new Customer(user.get(), adresse.get());
        };
    }
